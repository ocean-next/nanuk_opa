...
!------------------------------------------------------------------------------
   ...
   cn_icerst_in  = "ICERST_IN"   !  suffix of ice restart name (input)
   cn_icerst_indir = "CN_IN_ICERST"!  directory from which to read input ice restarts
   cn_icerst_out = "ICERST_OUT"   !  suffix of ice restart name (output)
   cn_icerst_outdir = "CN_OUT_ICERST" !  directory in which to write output ice restarts
...
!------------------------------------------------------------------------------
   ...
   ln_limini_file = .true.
   sn_hicif = 'Ice_initialization'    , -12 ,'hicif'   ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_hsnif = 'Ice_initialization'    , -12 ,'hsnif'   ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_frld  = 'Ice_initialization'    , -12 ,'frld'    ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_sist  = 'Ice_initialization'    , -12 ,'sist'    ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_tbif1 = 'Ice_initialization'    , -12 ,'tbif1'   ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_tbif2 = 'Ice_initialization'    , -12 ,'tbif2'   ,  .false.  , .true., 'yearly'  , '' , '', ''
   sn_tbif3 = 'Ice_initialization'    , -12 ,'tbif3'   ,  .false.  , .true., 'yearly'  , '' , '', ''
   cn_dir='./'
...
!------------------------------------------------------------------------------
   ...
   rn_cio         =    1.0e-2  ! 5.0e-3 !  ice-ocean drag coefficient           (-)             
...
!------------------------------------------------------------------------------
   ...
   ln_frazil   = .true.            !  use frazil ice collection thickness as a function of wind (T) or not (F)
