...
CONTAINS
   ...
   SUBROUTINE lim_wri( kindic )
      ...
      IF( iom_use('qsr_oce') )   CALL iom_put( "qsr_oce" , qsr_oce(:,:) * pfrld(:,:) )                                   ! solar    heat flux at ocean surface
      IF( iom_use('qla_oce') )   CALL iom_put( "qla_oce" , qla_oce(:,:) * pfrld(:,:) )                                   ! latent   heat flux at ocean surface
      IF( iom_use('qsb_oce') )   CALL iom_put( "qsb_oce" , qsb_oce(:,:) * pfrld(:,:) )                                   ! sensible heat flux at ocean surface
      IF( iom_use('qlw_oce') )   CALL iom_put( "qlw_oce" , qlw_oce(:,:) * pfrld(:,:) )                                   ! longwave heat flux at ocean surface
