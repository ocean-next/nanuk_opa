...
CONTAINS
   ...
   SUBROUTINE sbc_ssr( kt )
      ...
      REAL(wp) ::   zno_sssr_ice  ! to avoid SSS restoring under sea-ice
...
!CT CREG turn on/off damping under sea-ice } 
   ...
   SUBROUTINE sbc_ssr_init
      ...
      NAMELIST/namsbc_ssr/ ln_sssr_bnd, rn_sssr_bnd, ln_sssr_flt, ln_sssr_msk, sn_coast, rn_dist, nn_shap_iter, ln_sssr_ice
      INTEGER     ::  ios
      !!----------------------------------------------------------------------
      !
