...
!===========
   ...
   TYPE(FLD_N) ::   sn_tmxn_mpb, sn_tmxn_mpp, sn_tmxn_mpc, sn_tmxn_dsb, sn_tmxn_dsc
...
CONTAINS
   ...
   SUBROUTINE zdf_tmx_init
      ...
      !!
      NAMELIST/namzdf_tmx_new/ nn_zpyc, ln_mevar, ln_tsdiff, sn_tmxn_mpb, sn_tmxn_mpp, sn_tmxn_mpc, sn_tmxn_dsb, sn_tmxn_dsc
      !!----------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('zdf_tmx_init')
      !
